...
import main.java.modelo.Operacion;
...
public interface OperacionRepository extends JpaRepository<Operacion, Integer>{
        ...
        @Modifying
        @Transactional
        @Query(value = "INSERT INTO Operaciones (id_operacion,fecha,monto,saldo_final_salida,saldo_final_entrada,id_cuenta_llegada,producto_salida,punto_atencion) 
        VALUES ( bancAndes_seq.nextval , :id_operacion,:fecha,:monto,:saldo_final_salida,:saldo_final_entrada,:id_cuenta_llegada,:producto_salida,:punto atencion)", nativeQuery = true)
