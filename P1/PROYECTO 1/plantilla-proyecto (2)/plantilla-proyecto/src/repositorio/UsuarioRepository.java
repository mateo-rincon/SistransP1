...
public interface UsuarioRepository extends JpaRepository<Usuario, Integer>{
        ...
        @Modifying
        @Transactional
        @Query(value = "INSERT INTO usuarios (login, clave, documento_identidad, tipo_documento, nombre, nacionalidad, direccion_electronica, telefono) 
        VALUES ( bancAndes_seq.nextval , :login,:clave, :documento_identidad,:tipo_documento,:nombre, :nacionalidad, :direccion_electronica, :telefono)", nativeQuery = true)
