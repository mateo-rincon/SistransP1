...
public interface ProductoRepository extends JpaRepository<Producto, Integer>{
        ...
        @Modifying
        @Transactional
        @Query(value = "INSERT INTO Productos (id_producto, fechaDeCreacion, id_cliente, id_oficina) 
        VALUES ( bancAndes_seq.nextval , :id_producto,:fechaDeCreacion,:id_cliente,:id_oficina)", nativeQuery = true)
