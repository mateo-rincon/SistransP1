...
import main.java.modelo.Prestamo;
...
public interface PrestamoRepository extends JpaRepository<Prestamo, Integer>{
        ...
        @Modifying
        @Transactional
        @Query(value = "INSERT INTO Prestamos (id_prestamo,,tipo,valor_total,saldo_pendiente	cuotas,cuotas_pendientes,valor_cuota,dia_corte,interes) 
        VALUES ( bancAndes_seq.nextval , :id_Prestamo,:tipo,:valor_total,:saldo_pendiente	,:cuotas,:cuotas_pendientes,:valor_cuota,:dia_corte,:interes)", nativeQuery = true)
